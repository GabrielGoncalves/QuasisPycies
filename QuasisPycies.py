...
Module to calculate diversity indices from NGS data. It consists of two main 
...
class Clusters(object):
    ...
    def number_haplotypes(self, value_type, cutoff):
        ...
        cutoff. The cutoff can be "percentage" or "number_reads" (must discribe
...
class Pileup(object):     
    '''This class is in charge of dealing with pileup
