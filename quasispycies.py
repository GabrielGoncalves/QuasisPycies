...
class Clusters(object):
    ...
    def filtering_clusters_by_percentage_to_fasta(self, minimun_perc, output_fasta):
        ''' This function filters the clusters by percentage and writes it 
        to an output file. A minimun_perc (from 0 to 1) must be provided to 
        filter only the reads above this value and also the file name 
        (output_fasta).
        '''
...
def normalize_percentage(input1,output1):
    '''This function normalizes sequence clusters after filtering. As part of 
    the clusters are below the error rate, after filtering the remaining 
    clusters percentages would not sum to 100%. So this function recalculates 
    the percentage based on the number of reads of clusters above the error rate and writes it to
    the sequence name.
    '''
    file_in = open (input1, "r")
    fasta_in = file_in.readlines()
...
def sam_to_fasta(SAM_file, fasta_file):
    '''Converts sam file to fasta file. 
    Must provide the name of the sam file and fasta file as paramenters.
    '''
    SAM = open (SAM_file, "r")
...
def fastq_to_fasta(fastq_file, fasta_file):
    ...
    Must provide the name of the fastq file and fasta file as paramenters.
    '''
